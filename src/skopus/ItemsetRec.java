...
//		ItemsetRec ir = (ItemsetRec) o;
//		if (this.size() != ir.size()) {
//			return false;
//		}
//
//		for (int i = 0; i < this.size(); i++) {
////			int nthisi = this.get(i);
////			int noi = ir.get(i);
////			if (nthisi != noi) 
//			if ((int) (this.get(i)) != (int) (ir.get(i))) {
//				return false;
//			}
//		}
//		return true;
	...
	public String toString() {
		...
		if (this.size() > 0) {
			for (int i = 0; i < this.size() - 1; i++) {
				strResult += GlobalData.alItemName.get(this.get(i)) + ", ";
			}
		...
		strResult += "\t\tSupport="+count+"\tInterestingness=" +  value;
